...
namespace PaControlDemo.Service;
...
public class DataService
{
    ...
    internal List<DemoDataModel> GetDemoDataList()
    {
        ...
        for (var i = 1; i <= 20; i++)
        {
            ...
            var model = new DemoDataModel
            {
                ...
                Type = (DemoType) (i % 6 + 1),
                DataList = dataList,
                ImgPath = $"/PaControlDemo;component/Resources/Img/Avatar/avatar{i % 6 + 1}.png",
    ...
    internal List<DemoDataModel> GetDemoDataList(int count)
    {
        ...
        for (var i = 1; i <= count; i++)
        {
            ...
            var model = new DemoDataModel
            {
                ...
                Name = $"Name{i}",
                Type = (DemoType) index,
                ImgPath = $"/PaControlDemo;component/Resources/Img/Avatar/avatar{index}.png",
                Remark = new string(i.ToString()[0], 10)
            };
            list.Add(model);
        }
    ...
    internal List<AvatarModel> GetContributorDataList()
    {
        ...
        try
        {
            var json = client.DownloadString(new Uri("https://api.github.com/repos/nabian/PaControl/contributors"));
        ...
        {
            PaControl.Controls.MessageBox.Error(e.Message, Lang.Error);
        }
    ...
    internal ObservableCollection<CardModel> GetCardDataList()
    {
        return new()
        {
            ...
            {
                Header = "Atomic",
                Content = "/PaControlDemo;component/Resources/Img/Album/1.jpg",
                Footer = "Stive Morgan"
            },
            new CardModel
            {
                Header = "Zinderlong",
                Content = "/PaControlDemo;component/Resources/Img/Album/2.jpg",
                Footer = "Zonderling"
            },
            new CardModel
            {
                Header = "Busy Doin' Nothin'",
                Content = "/PaControlDemo;component/Resources/Img/Album/3.jpg",
                Footer = "Ace Wilder"
            },
            new CardModel
            {
                Header = "Wrong",
                Content = "/PaControlDemo;component/Resources/Img/Album/4.jpg",
                Footer = "Blaxy Girls"
            },
            new CardModel
            {
                Header = "The Lights",
                Content = "/PaControlDemo;component/Resources/Img/Album/5.jpg",
                Footer = "Panda Eyes"
            },
            new CardModel
            {
                Header = "EA7-50-Cent Disco",
                Content = "/PaControlDemo;component/Resources/Img/Album/6.jpg",
                Footer = "еяхат музыка"
            },
            new CardModel
            {
                Header = "Monsters",
                Content = "/PaControlDemo;component/Resources/Img/Album/7.jpg",
                Footer = "Different Heaven"
            },
            new CardModel
            {
                Header = "Gangsta Walk",
                Content = "/PaControlDemo;component/Resources/Img/Album/8.jpg",
                Footer = "Illusionize"
            },
            new CardModel
            {
                Header = "Won't Back Down",
                Content = "/PaControlDemo;component/Resources/Img/Album/9.jpg",
                Footer = "Boehm / Benjamin Francis Leftwich"
            },
            new CardModel
            {
                Header = "Katchi",
                Content = "/PaControlDemo;component/Resources/Img/Album/10.jpg",
    ...
    internal CardModel GetCardData()
    {
        return new()
        {
            Content = $"/PaControlDemo;component/Resources/Img/Album/{DateTime.Now.Second % 10 + 1}.jpg"
        };
    }
    ...
    internal ObservableCollection<CoverViewDemoModel> GetCoverViewDemoDataList()
    {
        return new()
        {
            ...
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/1.jpg",
                BackgroundToken = ResourceToken.SuccessBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/2.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/3.jpg",
                BackgroundToken = ResourceToken.WarningBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/4.jpg",
                BackgroundToken = ResourceToken.DangerBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/5.jpg",
                BackgroundToken = ResourceToken.SuccessBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/6.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/7.jpg",
                BackgroundToken = ResourceToken.InfoBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/8.jpg",
                BackgroundToken = ResourceToken.WarningBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/9.jpg",
                BackgroundToken = ResourceToken.PrimaryBrush
            },
            new CoverViewDemoModel
            {
                ImgPath = "/PaControlDemo;component/Resources/Img/Album/10.jpg",
                BackgroundToken = ResourceToken.DangerBrush
            }
        };
    }
    ...
    public string GetDemoUrl(DemoInfoModel demoInfo, DemoItemModel demoItem)
    {
        ...
        var domainName = LangProvider.Culture == null || LangProvider.Culture.Name.ToLower() == "zh-cn"
            ? "handyorg"
            : "ghost1372";
        return $"https://{domainName}.github.io/PaControl/{key}/{demoItem.Name[0].ToString().ToLower()}{demoItem.Name.Substring(1)}";
    }
}
